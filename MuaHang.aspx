...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="viewContent" class="box_new_1">
        <div class="viewCart">
            <center>
                <h2>
                    <div class="title_name_cart" style="color:blue">
                Trung Tâm Thiết Bị Gia Dụng - Vật Liệu Xây Dựng Bình An</div>
                </h2>
            </center>
            <asp:Repeater ID="rptOrder" runat="server" OnItemCommand="rptOrder_ItemCommand" OnItemDataBound="rptOrder_ItemDataBound">
                ...
                <ItemTemplate>
                    <div>
                        <b>
                            <asp:Label ID="lbsoluong" runat="server" Text="Sản phẩm bạn vừa chọn:"></asp:Label>
                        </b>
                    </div>
                    <tr>
